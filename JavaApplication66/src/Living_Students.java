 ...
 */
public class Living_Students extends javax.swing.JFrame {
      ...
      //  jTable1.setEnabled(false);
        ...
        catch(Exception e)
        {
         ...
         try{
            ...
            ResultSet rs=st.executeQuery("select * from new_Student where Living ='Yes'");
         //   while(rs.next())
         //   {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Students Living In Hostel");
