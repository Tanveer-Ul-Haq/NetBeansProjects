 ...
 */
public class Update_and_delete_Employee extends javax.swing.JFrame {
    ...
    public Update_and_delete_Employee() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Update and Delete Employee Data Form");
        ...
        jLabel11.setText("Working Status");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String Working = jComboBox2.getSelectedItem().toString();
        
           try{
                
                conn.createStatement().executeQuery("update new_employee set name='"+Name+"',Fname='"+Fname+"',ID_No='"+CNIC+"',Email_ID='"+Email+"',Phone_No='"+Phone+"',Address='"+Address+"',Designation='"+Designation+"',Working='"+Working+"' where ID_No='"+CNIC+"'");
                JOptionPane.showMessageDialog(this,"Employee data Updated Successfully","",JOptionPane.PLAIN_MESSAGE);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(jTextField3.getText().isEmpty())
        {
         ...
         try{
            ...
            ResultSet rs=st.executeQuery("Select * from new_employee where ID_No like '%"+tf+"%'");
            ...
            if(rs.next())
            {
                 ...
                 {
                     jComboBox1.addItem(designation);
            ...
            //     jComboBox1.setSelectedItem(room);
                 ...
                 jComboBox2.setSelectedItem(working);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String tf = jTextField1.getText();
         try{
            Statement st=conn.createStatement();
            ResultSet rs=st.executeQuery("Select * from new_employee where Name= '"+tf+"'");
            ...
            {
                 JOptionPane.showMessageDialog(this,"No data Exists \n\nEnter correct data\nOR\nTry with CNIC Number");
                        jTextField1.setText("");
                        jTextField2.setText("");
                        jTextField3.setText("");
                        jTextField4.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         {
             try{
              conn.createStatement().executeQuery("delete from new_employee where ID_No='"+tf+"'");
               JOptionPane.showMessageDialog(this,"Employee Data Deleted Successfully","",JOptionPane.PLAIN_MESSAGE);
