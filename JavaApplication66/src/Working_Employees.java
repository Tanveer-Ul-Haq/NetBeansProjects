 ...
 */
public class Working_Employees extends javax.swing.JFrame {
    ...
    public Working_Employees() {
        ...
        catch(Exception e)
        {
         ...
         try{
            ...
            ResultSet rs=st.executeQuery("select * from new_employee where Working ='Yes'");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Working Employees");
