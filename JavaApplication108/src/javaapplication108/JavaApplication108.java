...
public class JavaApplication108 {
    ...
    public static void main(String[] args) {
        ...
        JavaApplication108 obj = new JavaApplication108();
    }
	...
	public JavaApplication108(int memSize) {
 ...
 class Process  {
		...
		public Process(int process_id, int process_size) {
			...
			// memory it needs.
			int allocate_pages = JavaApplication108.splitMem(process_size, JavaApplication108.PAGE_SIZE);
		...
		public void print() {
			...
			int used = JavaApplication108.PAGE_SIZE;
			for (int i = 0; i < pages.length; i++) {
				if (i == pages.length - 1) {
					used = process_size % JavaApplication108.PAGE_SIZE;
					if (used == 0) {
						used = JavaApplication108.PAGE_SIZE;
					}
				}
...
//		}
		...
		public int internalFrag(){
			...
			internal_frag = process_size % JavaApplication108.PAGE_SIZE;
		
			if (internal_frag!=0){ 
			   internal_frag = JavaApplication108.PAGE_SIZE-internal_frag;	}
			return internal_frag;
